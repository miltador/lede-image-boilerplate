...
# Script vars
IMAGEBUILDER_URI="https://downloads.lede-project.org/releases/17.01.0-rc1/targets/ar71xx/generic/lede-imagebuilder-17.01.0-rc1-ar71xx-generic.Linux-x86_64.tar.xz"
BUILD_DEPS="build-essential libncurses5-dev zlib1g-dev gawk git ccache gettext libssl-dev xsltproc wget"

rm -r /tmp/lede-imagebuilder-17.0.1.0-rc1-ar71xx-generic.Linux-x86_64
...
cp -r $FILES /tmp/lede-imagebuilder-17.01.0-rc1-ar71xx-generic.Linux-x86_64

cd /tmp/lede-imagebuilder-17.01.0-rc1-ar71xx-generic.Linux-x86_64
